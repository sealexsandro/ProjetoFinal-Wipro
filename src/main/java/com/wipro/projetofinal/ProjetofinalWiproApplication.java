...
public class ProjetofinalWiproApplication {
	...
	public static void implementacaoManual() {
		/*
		 * CheckingAccount contaCorrente1 = new CheckingAccount(0.0, "Mario",
		 * "529.982.247-25"); CheckingAccount contaCorrente2 = new CheckingAccount(0.0,
		 * "Joao", "529.982.247-27"); CheckingAccount contaCorrente3 = new
		 * CheckingAccount(0.0, "Ana Beatriz", "529.982.247-28"); // CheckingAccount
		 * contaCorrente3 = new CheckingAccount(0.0, "Maria", "529.982.247-25"); //
		 * CheckingAccount contaCorrente4 = new CheckingAccount(0.0, "Neves",
		 * "529.982.247-25");
		 * 
		 * SpecialAccount contaEspecial1 = new
		 * SpecialAccount(0.0,"Freddy",300.00,"529.982.247-29");
		 * 
		 ...
		 * 
		 * // Imprimir todas as contas gerenciaContas.showAllAccounts();
		 * 
		 * // Buscar conta por cpf
		 * System.out.println(gerenciaContas.showAccount("529.982.247-278"));
		 * 
		 * // remover uma conta gerenciaContas.removeAccount("529.982.247-27"); // //
		 * Imprimir todas as contas gerenciaContas.showAllAccounts();
		 * 
		 * // Deve retornar null, porque a conta não "tem" um cartão de credito
		 * instanciado System.out.println("Antes de adicionar creditCard: " +
		 * contaCorrente1.getCreditCard());
		 * 
		 * gerenciaContas.activateCreditCard(contaCorrente1);
		 * 
		 * System.out.println("Depois de adicionar creditCard: " +
		 * contaCorrente1.getCreditCard());
		 * 
		 * 
		 * /*teste conta especial contaEspecial1.deposit(200);
		...
		/*
		 * teste conta corrente contaCorrente1.deposit(200);
		...
		/*
		 * try { contaCorrente1.deposit(-1);
		 * 
		 * contaCorrente1.withdraw(10); }catch(ErrorTypes e) {
		 * System.err.println(e.getMessage()); }
		 * System.out.println(gerenciaContas.showAccount("529.982.247-25"));
		 */

		/*
		 * saques contaCorrente1.withdraw(10);
		 * 
